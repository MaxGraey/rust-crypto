...
impl Blake2b {
  fn set_lastnode(&mut self) { self.f[1] = 0xFFFFFFFFFFFFFFFF; }
  ...
  pub fn blake2b(out: &mut [u8], input: &[u8], key: &[u8]) {
    let mut hasher: Blake2b = if key.len() > 0 {
...
mod mac_tests {
  ...
  fn test_blake2b_mac() {
    ...
    m.input(&[1, 2, 4, 8]);
    let expected = [
      0x8e, 0xc6, 0xcb, 0x71, 0xc4, 0x5c, 0x3c, 0x90, 0x91, 0xd0, 0x8a, 0x37, 0x1e, 0xa8, 0x5d,
      0xc1, 0x22, 0xb5, 0xc8, 0xe2, 0xd9, 0xe5, 0x71, 0x42, 0xbf, 0xef, 0xce, 0x42, 0xd7, 0xbc,
      0xf8, 0x8b, 0xb0, 0x31, 0x27, 0x88, 0x2e, 0x51, 0xa9, 0x21, 0x44, 0x62, 0x08, 0xf6, 0xa3,
      0x58, 0xa9, 0xe0, 0x7d, 0x35, 0x3b, 0xd3, 0x1c, 0x41, 0x70, 0x15, 0x62, 0xac, 0xd5, 0x39,
      0x4e, 0xee, 0x73, 0xae,
    ];
