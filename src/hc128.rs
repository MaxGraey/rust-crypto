...
mod test {
    ...
    fn test_hc128_ecrypt_set_2_vector_0() {
        let key = Vec::from_hex("00000000000000000000000000000000").unwrap();
    ...
    fn test_hc128_ecrypt_set_6_vector_1() {
        let key = Vec::from_hex("0558ABFE51A4F74A9DF04396E93C8FE2").unwrap();
        let nonce = Vec::from_hex("167DE44BB21980E74EB51C83EA51B81F").unwrap();
    ...
    fn test_hc128_ecrypt_set_6_vector_2() {
        let key = Vec::from_hex("0A5DB00356A9FC4FA2F5489BEE4194E7").unwrap();
        let nonce = Vec::from_hex("1F86ED54BB2289F057BE258CF35AC128").unwrap();
    ...
    fn test_hc128_ecrypt_set_6_vector_3() {
        let key = Vec::from_hex("0F62B5085BAE0154A7FA4DA0F34699EC").unwrap();
