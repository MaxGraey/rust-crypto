...
mod test {
  ...
  fn from_hex(raw_hex: &str) -> Vec<u8> {
    Vec::from_hex(raw_hex).ok().unwrap()
  }
  ...
  fn get_test_vectors()-> [TestVector; 5]{[
    TestVector {
      key:         from_hex("00000000000000000000000000000000"),
      iv:          from_hex("000000000000000000000000"),
      plain_text:  from_hex(""),
      cipher_text: from_hex(""),
      aad:         from_hex(""),
      tag:         from_hex("58e2fccefa7e3061367f1d57a4e7455a")
    },

    TestVector {
      key:         from_hex("00000000000000000000000000000000"),
      iv:          from_hex("000000000000000000000000"),
      plain_text:  from_hex("00000000000000000000000000000000"),
      cipher_text: from_hex("0388dace60b6a392f328c2b971b2fe78"),
      aad:         from_hex(""),
      tag:         from_hex("ab6e47d42cec13bdf53a67b21257bddf")
    },

    TestVector {
      key:         from_hex("feffe9928665731c6d6a8f9467308308"),
      iv:          from_hex("cafebabefacedbaddecaf888"),
      plain_text:  from_hex("d9313225f88406e5a55909c5aff5269a86a7a9531534f7da2e4c303d8a318a721\
                             c3c0c95956809532fcf0e2449a6b525b16aedf5aa0de657ba637b39"),
      cipher_text: from_hex("42831ec2217774244b7221b784d0d49ce3aa212f2c02a4e035c17e2329aca12e2\
                             1d514b25466931c7d8f6a5aac84aa051ba30b396a0aac973d58e091"),
      aad:         from_hex("feedfacedeadbeeffeedfacedeadbeefabaddad2"),
      tag:         from_hex("5bc94fbc3221a5db94fae95ae7121a47")
    },

    TestVector {
      key:         from_hex("feffe9928665731c6d6a8f9467308308feffe9928665731c"),
      iv:          from_hex("cafebabefacedbaddecaf888"),
      plain_text:  from_hex("d9313225f88406e5a55909c5aff5269a86a7a9531534f7da2e4c303d8a318a721\
                             c3c0c95956809532fcf0e2449a6b525b16aedf5aa0de657ba637b39"),
      cipher_text: from_hex("3980ca0b3c00e841eb06fac4872a2757859e1ceaa6efd984628593b40ca1e19c7\
                             d773d00c144c525ac619d18c84a3f4718e2448b2fe324d9ccda2710"),
      aad:         from_hex("feedfacedeadbeeffeedfacedeadbeefabaddad2"),
      tag:         from_hex("2519498e80f1478f37ba55bd6d27618c")
    },

    TestVector {
      key:         from_hex("feffe9928665731c6d6a8f9467308308feffe9928665731c6d6a8f9467308308"),
      iv:          from_hex("cafebabefacedbaddecaf888"),
      plain_text:  from_hex("d9313225f88406e5a55909c5aff5269a86a7a9531534f7da2e4c303d8a318a721\
                             c3c0c95956809532fcf0e2449a6b525b16aedf5aa0de657ba637b39"),
      cipher_text: from_hex("522dc1f099567d07f47f37a32a84427d643a8cdcbfe5c0c97598a2bd2555d1aa8\
                             cb08e48590dbb3da7b08b1056828838c5f61e6393ba7a0abcc9f662"),
      aad:         from_hex("feedfacedeadbeeffeedfacedeadbeefabaddad2"),
      tag:         from_hex("76fc6ece0f4e1768cddf8853bb2d551b")
    },
  ]}
